...
CREATE TABLE `user` (
  ...
  `desc` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `user` VALUES (1,'ricky','苦主'),(2,'nick','路人甲'),(3,'jack','路人乙');
...
-- Dump completed on 2023-03-28 10:51:42
